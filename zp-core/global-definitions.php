...
define('DEBUG_IMAGE_ERR', !defined('RELEASE')); // set to true to flag image processing errors.
define('DEBUG_ALBUM_ERR', !defined('RELEASE')); // set to true to flag album instantiation errors.
