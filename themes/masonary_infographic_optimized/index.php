...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <!--[if lt IE 8]>
     ...
     <![endif]-->
        <?php zp_apply_filter('theme_body_open'); ?><?php include('_siteHeaderNav.php' ); ?>
        <div id="main" class='row evencolumns' style="padding-top:50px;">
            ...
            foreach ($collection as $key => $value) {
                ...
                if( $D3_Master_Array2[$datestamp] == NULL ){ //chekcing if the date is used.
                    ...
                    "r" => 1
                     ...
                     if( $D3_Master_Array2[$parentdatestamp] == NULL ){
              ...
              if($D3_Grouped_TypeArray[ $type[0] ] == NULL){  //checking if this parent has been used.
